                ...
                <?php if(count($themes)): ?>
                    <?php $__currentLoopData = $themes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm text-white edit-theme-btn" data-theme-id="<?php echo e($theme->id); ?>"><i class="feather icon-edit"></i> Edit</a>
                                <a class="btn btn-danger btn-sm text-white delete-theme-btn" data-theme-id="<?php echo e($theme->id); ?>"><i class="feather icon-trash-2"></i>Delete</a>
                            </td>
                        </tr>
    ...
    <div id="addModal" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="danger-header-modalLabel" style="display: none" aria-modal="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <form id="add-form" method="POST" action="<?php echo e(route('admin.theme.store')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\deals\resources\views/pages/theme/theme.blade.php ENDPATH**/ ?>