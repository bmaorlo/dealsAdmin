...
<div class="left-side-menu">
 <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 937px;"><div class="slimscroll-menu active" style="overflow: hidden; width: auto; height: 937px; margin-top: 50px">
    ...
    <ul class="metismenu side-nav in">
        ...
        <li class="menu-item mt-3 <?php echo e(Request::is('admin/dashboard*') ? 'menu-item-active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is('admin/location*') ? 'menu-item-active' : ''); ?>">
            <a href="<?php echo e(route('admin.location.index')); ?>" class="menu-link">
                <span class="menu-item-active-here"></span>
        ...
        <li class="menu-item <?php echo e(Request::is('admin/theme*') ? 'menu-item-active' : ''); ?>">
            <a href="<?php echo e(route('admin.theme.index')); ?>" class="menu-link">
                <span class="menu-item-active-here"></span>
        ...
        <li class="menu-item <?php echo e(Request::is('admin/m-theme-location*') ? 'menu-item-active' : ''); ?>">
            <a href="<?php echo e(route('admin.m-theme-location.index')); ?>" class="menu-link">
                <span class="menu-item-active-here"></span>
        ...
        <li class="menu-item <?php echo e(Request::is('admin/special-date*') ? 'menu-item-active' : ''); ?>">
            <a href="<?php echo e(route('admin.special-date.index')); ?>" class="menu-link">
                <span class="menu-item-active-here"></span>
        ...
        <li class="menu-item <?php echo e(Request::is('admin/deal*') ? 'menu-item-active' : ''); ?>">
            <a href="<?php echo e(route('admin.deal.index')); ?>" class="menu-link">
                <span class="menu-item-active-here"></span>
        ...
        <li class="menu-item <?php echo e(Request::is('admin/import-deal*') ? 'menu-item-active' : ''); ?>">
            <a href="<?php echo e(route('admin.deal.import-json')); ?>" class="menu-link">
                <span class="menu-item-active-here"></span>
                <i class="mdi mdi-camera-image"></i>
