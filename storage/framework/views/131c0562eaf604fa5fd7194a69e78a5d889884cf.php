        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user arrow-none mx-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                <span class="account-user-avatar">
                    <img src="<?php echo e(asset('assets/images/users/avatar.png')); ?>" alt="user-image" class="rounded-circle user-photo-image">
                </span>
                <span>
...
<?php /**PATH C:\xampp\htdocs\deals\resources\views\includes\dashboard\header.blade.php ENDPATH**/ ?>