...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card sale-card mt-3">
        <div class="card-header text-center d-flex justify-content-end">
            ...
            <div class="d-flex justify-content-end col-6"><a  href="<?php echo e(route('admin.location.create')); ?>"  class="btn btn-primary" ><i style="font-size:16px;" class="ion ion-md-add"></i>&nbsp;&nbsp;Add New Location</a></div>
        </div>
                    ...
                    <?php if(count($locations)): ?>
                        <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($location->locationAbout); ?></td>
                                <td>
                                    <a href="<?php echo e($location->locationPhoto); ?>" target="_blank"><?php echo e(Str::limit($location->locationPhoto, 60)); ?></a>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.location.edit',$location->id)); ?>" class="btn btn-primary btn-sm text-white edit-location-btn"><i class="feather icon-edit"></i> Edit</a>
                                    <a class="btn btn-danger btn-sm text-white delete-location-btn" data-location-id="<?php echo e($location->id); ?>"><i class="feather icon-trash-2"></i>Delete</a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\deals\resources\views/pages/location/location.blade.php ENDPATH**/ ?>