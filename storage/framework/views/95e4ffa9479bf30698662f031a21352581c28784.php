    ...
    <div class="card sale-card mt-3">
        ...
        <div class="col-12 mt-3 mb-3" style="max-width: 1000px;">
            ...
            <table class="table table-bordered table-responsive full-width" id="special-date-table">
                ...
                <tbody>
                <?php if(count($specialDates)): ?>
                    <?php $__currentLoopData = $specialDates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialDate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($specialDate->id); ?></td>
                            <td><?php echo e($specialDate->name); ?></td>
                            <td><?php echo e(date('Y-m-d', strtotime($specialDate->from_date))); ?></td>
                            <td><?php echo e(date('Y-m-d', strtotime($specialDate->to_date))); ?></td>
                            <td>
                                <?php if($specialDate->active): ?>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm text-white edit-special-date-btn" data-theme-id="<?php echo e($specialDate->id); ?>"><i class="feather icon-edit"></i> Edit</a>
                                <a class="btn btn-danger btn-sm text-white delete-special-date-btn" data-theme-id="<?php echo e($specialDate->id); ?>"><i class="feather icon-trash-2"></i>Delete</a>
                            </td>
                        </tr>
    ...
    <div id="addModal" class="modal fade" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="danger-header-modalLabel" style="display: none" aria-modal="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <form id="add-form" method="POST" action="<?php echo e(route('admin.special-date.store')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\deals\resources\views/pages/special-date/special-date.blade.php ENDPATH**/ ?>